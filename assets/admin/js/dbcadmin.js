$(function() {
    ...
    var t = $(".dbc-nav .dropdown-toggle > .fa-bell + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".dbc-nav .dropdown-toggle > .fa-bell").addClass("anim-swing")
    }
    t = $(".dbc-nav .dropdown-toggle > .fa-envelope + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".dbc-nav .dropdown-toggle > .fa-envelope").addClass("anim-top-down")
    }
