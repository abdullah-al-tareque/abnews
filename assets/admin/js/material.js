$(function() {
    function e() {
        ...
        if ($.cookie("sidebar-collapsed") == "true") {
            ...
            $(".admin-logo-holder").addClass("admin-logo-holder-collapsed");
    ...
    var t = $(".webhelios-nav .dropdown-toggle > .fa-bell + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".webhelios-nav .dropdown-toggle > .fa-bell").addClass("anim-swing")
    }
    t = $(".webhelios-nav .dropdown-toggle > .fa-envelope + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".webhelios-nav .dropdown-toggle > .fa-envelope").addClass("anim-top-down")
    }
    ...
    $("#sidebar-collapse").click(function() {
        ...
        $(".admin-logo-holder").toggleClass("admin-logo-holder-collapsed");
