        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel1"><?php echo lang_key('login_to_your_account'); ?> </h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="well login-reg-form">
                        ...
                        <!-- Form -->
                        <form action="<?php echo site_url('account/login');?>" class="form-horizontal"  method="post">
                            <!-- Form Group -->
                            <div class="form-group">
                                <!-- Label -->
                                <label class="col-sm-3 control-label"><?php echo lang_key('email'); ?></label>
                                <div class="col-sm-9">
                                    <!-- Input -->
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo lang_key('password'); ?></label>
                                <div class="col-sm-9">
                        ...
                        <br />
                        <?php
                        $fb_enabled = get_settings('global_settings','enable_fb_login','No');
                        $gplus_enabled = get_settings('global_settings','enable_gplus_login','No');
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2"><?php echo lang_key('upgrade_browser'); ?> </h4>
...
?>
<!-- added on version 1.4 -->
<?php if(get_settings('global_settings','enable_adblocker_alert','No')=='Yes'){?>
