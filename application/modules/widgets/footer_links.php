<ul class="list-inline pull-right">
    ...
    <li><a href="<?php echo site_url('page/term_condition');?>"><?php echo lang_key('Term & Condition')?></a></li>
    <li><a href="<?php echo site_url('page/privacy_policy');?>"><?php echo lang_key('Privacy Policy')?></a></li>
