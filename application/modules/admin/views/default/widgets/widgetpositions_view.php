...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key_admin('widget_positions');?></h3>
                <div class="box-tool">
                ...
                <form action="<?php echo site_url('admin/widgets/widgetpositions')?>" method="post">
                    <div class="form-group"  style="padding-left:0">
                        <div class="col-sm-4 col-lg-5 controls" style="padding-left:0">
                            <label><?php echo lang_key_admin('widget_positions');?>:</label>
                    ...
                    <a href="" class="show-widget-positions"><?php echo lang_key_admin('explain_widget_position');?></a>
                </form>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key_admin('available_widgets');?></h3>
                <div class="box-tool">
                    <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                ...
                <ol id="sortable1" class="droptrue">
                    <?php foreach($widgets->result() as $row){?>
                        <?php if(isset($active_widgets_array[$row->alias])==FALSE){?>
                            <li class="thumbnail col-md-3" style="margin-bottom:10px;cursor: move;height:41px;">
                                <input type="hidden" name="widget[]" value="<?php echo $row->alias;?>">
                                <div style="float:left;padding:5px;"><?php echo $row->name;?></div>
                                <a href="<?php echo site_url('admin/widgets/edit/'.$row->alias);?>" style="float:right;" class="edit-widget btn btn-info"><?php echo lang_key_admin('edit');?></a>
                            </li>
                        <?php }?>
                    <?php }?>
                </ol>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key_admin('active_widgets');?></h3>
                <div class="box-tool">
                    <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
            ...
            <div class="box-content">
                <form action="<?php echo site_url('admin/widgets/savewidgetpositions');?>" id="positions_widgets_form" method="post">
                    ...
                    <h5><?php echo lang_key_admin('active_widget_position');?> : <?php echo convert_widget_text($selected_pos);?></h5>
                    <?php
                    $CI = get_instance();
                                ...
                                if(isset($row->name))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        <li class="thumbnail col-md-3" style="margin-bottom:10px;cursor: move;height:41px;">
                                            ...
                                            <div style="float:left;padding:5px;"><?php echo $row->name;?></div>
                                            <a href="<?php echo site_url('admin/widgets/edit/'.$widget);?>" style="float:right;" class="edit-widget btn btn-info"><?php echo lang_key_admin('edit');?></a>
                                        </li>
                                    <?php
                                    }
                                }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo lang_key_admin('widget_position'); ?> </h4>
