<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="box-title">
				<h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('select_language');?></h3>
				<div class="box-tool">
			...
			<div class="box-content">
				<label><?php echo lang_key_admin('select_language_file');?></label> 
				...
				<a id="sel_lang_form" href="<?php echo site_url('admin/system/editlang/'.$row->id);?>" class="btn btn-primary"><?php echo lang_key_admin('edit');?></a>
				<a id="edit_as_new_lang" href="<?php echo site_url('admin/system/editasnewlang/'.$row->id);?>" class="btn btn-info"><?php echo lang_key_admin('edit_as_new');?></a>
				<a id="delete_lang" href="<?php echo site_url('admin/system/deletelang/'.$row->id);?>" class="btn btn-danger"><?php echo lang_key_admin('delete');?></a>
			</div>
		</div>
	</div>
</div>	
			...
			<div class="box-content">
				...
				<form action="<?php echo site_url('admin/system/savelang');?>" method="post">
					...
					<div class="form-group">
						<label class="col-sm-1 col-lg-1 control-label"><?php echo lang_key_admin('language');?></label>
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="lang" value="<?php echo (isset($row->lang))?$row->lang:set_value('lang');?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
					...
					<div class="form-group">
						<label class="col-sm-1 col-lg-1 control-label"><?php echo lang_key_admin('short_name');?></label>
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="short_name" value="<?php echo (isset($row->short_name))?$row->short_name:set_value('short_name');?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
							<span class="help-inline">&nbsp;</span>
					...
					<a href="javascript:void(0);" class="addanother btn btn-info" style="margin-left:25px;margin-bottom:5px;"><?php echo lang_key_admin('add_another');?></a><br/>
					<button type="submit" class="btn btn-primary"><?php echo lang_key_admin('save');?></button>
				</form>
			</div>
		</div>
	</div>
