<div class="row">	
  <div class="col-md-12">
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('edit_category');?></h3>
        <div class="box-tool">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/category/updatecategory');?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="title" value="<?php echo(set_value('fa_icon')!='')?set_value('fa_icon'):$post->title;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control input-sm" >
				...
				<div class="form-group icon-class-holder">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="fa_icon" value="<?php echo(set_value('fa_icon')!='')?set_value('fa_icon'):$post->fa_icon;?>" placeholder="<?php echo lang_key_admin('fa-car');?>" class="form-control input-sm" >
