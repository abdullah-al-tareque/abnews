...
<head>
    ...
    <title><?php echo translate(get_settings('site_settings', 'site_title', 'Whizz classified')); ?> | <?php echo lang_key_admin('admin_panel');?></title>
    ...
    <div class="login-wrapper">
      ...
      <form id="form-login" action="<?php echo site_url('admin/auth/login/');?>" method="post">
          ...
          <div class="login-form-title">
              <h4><i class="fa fa-lock"></i> <?php echo translate(get_settings('site_settings', 'site_title', 'Videopilot')); ?></h4>
           </div>
           
            <div style="text-align:center">
                <img src="<?php echo get_site_logo();?>" style="height:60px; margin:20px 0px 0px;" />
            </div>
        ...
        <div class="form-group">
          <div class="controls">
                  <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="username" placeholder="<?php echo lang_key_admin('username_or_email');?>">
                  </div>
          </div>
        </div>
        <div class="form-group">
          <div class="controls">
                  <div class="input-group">
                      ...
                      <input class="form-control" type="password" name="password" placeholder="<?php echo lang_key_admin('password');?>">
                  </div>
          </div>
        </div>
