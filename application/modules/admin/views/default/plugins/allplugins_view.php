<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i><?php echo lang_key_admin('all_plugins');?></h3>
        <div class="box-tool">
      ...
      <div class="box-content">
        ...
        <div class="alert alert-info"><?php echo lang_key_admin('no_plugins');?></div>
        <?php }else{?>
        ...
        <table class="table table-striped">
           <thead>
               <tr>
                  <th class="numeric">#</th>
                  <th class="numeric"><?php echo lang_key_admin('name_and_version');?></th>
           ...
           <tbody>
        	<?php $i=1;foreach($posts->result() as $row):?>
               ...
               <tr>
                  ...
                  <td data-title="<?php echo lang_key_admin('name_and_version');?>" class="numeric"><?php echo $data->name.'('.$data->version.')'.'<br/>';?>
                  ...
                  <td data-title="<?php echo lang_key_admin('status');?>" class="numeric"><?php echo ($row->status==1)?'Enabled':'Disabled';?></td>
                  <td data-title="Actions" class="numeric">
                  	<div class="btn-group">
                        <button data-toggle="dropdown" class="btn dropdown-toggle"><?php echo lang_key_admin('action');?> <span class="caret"></span></button>
