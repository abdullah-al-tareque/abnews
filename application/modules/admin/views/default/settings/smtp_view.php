<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key_admin("smtp_email_settings") ?> </h3>
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/system/savesmtpemailsettings');?>" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_email'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_host'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('smtp_host')!='')?set_value('smtp_host'):get_settings('smtp_settings','smtp_host','ssl://smtp.googlemail.com');?>
                            <input type="text" name="smtp_host" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_port'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('smtp_port')!='')?set_value('smtp_port'):get_settings('smtp_settings','smtp_port','465');?>
                            <input type="text" name="smtp_port" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_timeout'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('smtp_timeout')!='')?set_value('smtp_timeout'):get_settings('smtp_settings','smtp_timeout','30');?>
                            <input type="text" name="smtp_timeout" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_user'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('smtp_user')!='')?set_value('smtp_user'):get_settings('smtp_settings','smtp_user','test@example.com');?>
                            <input type="text" name="smtp_user" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('smtp_password'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('smtp_pass')!='')?set_value('smtp_pass'):get_settings('smtp_settings','smtp_pass','');?>
                            <input type="text" name="smtp_pass" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('Charter Set'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('char_set')!='')?set_value('char_set'):get_settings('smtp_settings','char_set','utf-8');?>
                            <input type="text" name="char_set" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('New Line'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('new_line')!='')?set_value('new_line'):get_settings('smtp_settings','new_line','\r\n');?>
                            <input type="text" name="new_line" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key_admin('Mail Type'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <?php $v = (set_value('mail_type')!='')?set_value('mail_type'):get_settings('smtp_settings','mail_type','html');?>
                            <input type="text" name="mail_type" value="<?php echo $v;?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
