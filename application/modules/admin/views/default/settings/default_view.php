                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/system/savesettings/webadmin_email');?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="contact_email" value="<?php echo(isset($settings->contact_email))?$settings->contact_email:'';?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="webadmin_name" value="<?php echo(isset($settings->webadmin_name))?$settings->webadmin_name:'';?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="webadmin_email" value="<?php echo(isset($settings->webadmin_email))?$settings->webadmin_email:'';?>" placeholder="<?php echo lang_key_admin('type_something');?>" class="form-control" >
