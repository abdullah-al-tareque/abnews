  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('all_pages');?></h3>
        ...
        <table id="all-posts" class="table table-hover">
           ...
           <thead>
               ...
               <tr>
                  ...
                  <th class="numeric"><?php echo lang_key_admin('description');?></th>
           ...
           <tbody>
        	...
        	<?php $i=1;foreach($posts->result() as $row):?>
               ...
               <tr>
                  ...
                  <td data-title="<?php echo lang_key_admin('title');?>" class="numeric"><a href="<?php echo site_url('admin/page/manage/'.$row->id);?>"><?php echo $row->title;?></a></td>

                  <td data-title="<?php echo lang_key_admin('description');?>" class="numeric"><?php echo truncate(encode_html($row->content),30,'...',false);?></td>
                  ...
                  <td data-title="<?php echo lang_key_admin('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/page/manage/'.$row->id);?>"><?php echo lang_key_admin('edit');?></a></li>

                          <?php if($row->editable==1){?>
                          <?php $curr_page = ($this->uri->segment(5)!='')?$this->uri->segment(5):0;?>
                          <li><a href="<?php echo site_url('admin/page/delete/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key_admin('delete');?></a></li>
