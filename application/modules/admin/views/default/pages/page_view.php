  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-content">
		...
		<div class="form-group">
			...
			<label class="col-sm2 col-lg-2 control-label"><?php echo lang_key_admin('menu_title');?></label>

			<div class="col-sm-5 col-lg-6 controls">

				<input type="text" class="form-control" name="title" id="title" value="<?php echo $title;?>" placeholder="<?php echo lang_key_admin('type_something');?>" />
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('menu_alias');?></label>

			<div class="col-sm-2 col-lg-3 controls">

				<input type="text" class="form-control" name="alias" id="alias" value="<?php echo $alias;?>" placeholder="<?php echo lang_key_admin('type_something');?>" />
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('show_in_menu');?></label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('page_layout');?></label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('content_from');?></label>
		...
		<div class="form-group url">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('url');?></label>

			<div class="col-sm-5 col-lg-6 controls">

				<input type="text" class="form-control" name="url" value="<?php echo $url;?>" placeholder="<?php echo lang_key_admin('type_something');?>"  />
		...
		<div class="manual" style="min-height:500px;">
			...
			<div class="main-content" style="width:75%;float:left;margin:0">
				...
				<label><?php echo lang_key_admin('content');?></label>
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('seo_options');?></h3>
      ...
      <div class="box-content">
	      	...
	      	<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('meta_description');?>:</label>
			...
			<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('key_words');?>:</label>
			...
			<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label"><?php echo lang_key_admin('crawl_after');?>:</label>
