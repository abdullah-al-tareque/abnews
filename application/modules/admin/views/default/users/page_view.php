<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('edit_page');?></h3>
        <div class="box-tool">
      ...
      <div class="box-content">
		...
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label"><?php echo lang_key_admin('menu_title');?></label>
			<div class="col-sm-2 col-lg-3 controls">
				<input type="text" class="form-control" name="title" value="<?php echo $title;?>" placeholder="<?php echo lang_key_admin('type_something');?>" />
		...
		?>
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label"><?php echo lang_key_admin('page_layout');?></label>
			<div class="col-sm-2 col-lg-3 controls">
