    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i> <?php echo lang_key_admin('all_users'); ?></h3>
            ...
            <div class="box-content">
                ...
                <?php if ($posts->num_rows() <= 0) { ?>
                    <div class="alert alert-info"><?php echo lang_key_admin('no_pages'); ?></div>
                <?php } else { ?>
                    <a href="<?php echo site_url('admin/users/create');?>" class="btn btn-success"><?php echo lang_key_admin('create_user'); ?></a>
                    <a href="<?php echo site_url('admin/users/exportemails');?>" class="btn btn-info"><?php echo lang_key_admin('export_user_email'); ?></a>
                    ...
                    <div id="no-more-tables">
                        <table id="all-posts" class="table table-hover">
                            ...
                            <tr>
                                <th class="numeric">#</th>
                                <th class="numeric"><?php echo lang_key_admin('image'); ?></th>
                                <th class="numeric"><?php echo lang_key_admin('name'); ?></th>
                                <th class="numeric"><?php echo lang_key_admin('type');?></th>
                                <th class="numeric"><?php echo lang_key_admin('email'); ?></th>
                                <th class="numeric"><?php echo lang_key_admin('gender'); ?></th>
                                <th class="numeric"><?php echo lang_key_admin('status');?></th>
                                <th class="numeric"><?php echo lang_key_admin('options');?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i = 1;
                            ...
                            foreach ($posts->result() as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?php echo lang_key_admin('image'); ?>" class="numeric">

                                        <img src="<?php echo get_profile_photo_by_id($row->id,'thumb'); ?>" class="thumbnail" style="height:36px;">

                                    </td>
                                    <td data-title="<?php echo lang_key_admin('name'); ?>" class="numeric"><a

                                            href="<?php echo site_url('admin/users/detail/' . $row->id); ?>"><?php echo $row->user_name; ?></a>

                                    </td>
                                    <td data-title="<?php echo lang_key_admin('type');?>"  class="numeric">
                                    <?php 
                                        echo get_user_type_by_id($row->user_type);
                                    ?>
                                    </td>
                                    <td data-title="<?php echo lang_key_admin('email'); ?>" class="numeric"><?php echo $row->user_email;; ?></td>
                                    <td data-title="<?php echo lang_key_admin('gender'); ?>"
                                    ...
                                    <td data-title="<?php echo lang_key_admin('options');?>" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-info dropdown-toggle" data-toggle="dropdown"
                                               ...
                                               href=""><i class="fa fa-cog"></i> <?php echo lang_key_admin('action');?> <span
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <li><a href="<?php echo site_url('admin/edituser/' . $row->id); ?>"><?php echo lang_key_admin('edit');?></a>
                                                ...
                                                <?php if($row->user_type!=1){?>
                                                    ...
                                                    <li><a href="<?php echo site_url('admin/deleteuser/'.$page.'/'. $row->id); ?>"><?php echo lang_key_admin('delete');?></a>
