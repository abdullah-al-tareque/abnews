<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key_admin("debug_email") ?> </h3>
            ...
            <form action="<?php echo site_url('admin/system/debugemail');?>" method="post">
                <label><?php echo lang_key_admin('email_to');?></label>
                <input type="text" name="to_email" class="form-control">
                <div class="clearfix" style="margin-top:10px;"></div>
                <input type="submit" value="<?php echo lang_key_admin('send')?>" class="btn">
            </form>
